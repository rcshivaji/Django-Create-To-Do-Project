    ...
    if request.method=='GET':
        ...
        if request.POST['password1']==request.POST['password2']:
            try:
                ...
                return render(request,"signupuser.html",{'form':UserCreationForm(),'error':'Username is already taken !! Please choose another one'})
        else:
...
def createtodo(request):
    if request.method=='GET':
        ...
        try:
            ...
            return render(request,"createtodo.html",{'form':ToDoForm(),'error':'Please Go For a smaller Title !!!'})
...
def viewtodo(request,todo_pk):
    ...
    if request.method=='GET':
        ...
        try:
            ...
            return render(request,"viewtodo.html",{'todo':todo,'form':form,'error':"Bad data inputed !!"})
